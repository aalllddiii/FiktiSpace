...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2 class="text-danger text-center">Data REJECT Poster</h2>
        <a href="../" class="btn btn-info">⏎ Home</a>
        <a href="approve.php" class="btn btn-success">TO Approved</a>
        <a href="reject.php" class="btn btn-danger">TO Reject</a>
        <a href="../../config/poster_reject.php" class="btn btn-success float-right">Report Excel</a>
        <br><br>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" onclick="return confirm('Approve data?')" href="../../config/update/art_approve/pt.php?id=<?php echo $data['id']; ?>" role="button">✔</a><br>
