...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2 class="text-danger text-center">Data REJECT Photography</h2>
        <a href="../" class="btn btn-info">⏎ Home</a>
        <a href="approve.php" class="btn btn-success">TO Approved</a>
        <a href="reject.php" class="btn btn-danger">TO Reject</a>
        <a href="../../config/fotografi_reject.php" class="btn btn-success float-right">Report Excel</a>
        <br><br>
        <table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            $tampil = mysqli_query($conn, "SELECT 
                                            ...
                                            fspace_fotografi.nama_lengkap,
                                            fspace_fotografi.instansi,
                                            fspace_fotografi.kelas,
                                            fspace_fotografi.email,
                                            fspace_fotografi.nowa,
                                            fspace_fotografi.idline
                                            FROM fspace_account INNER JOIN fspace_fotografi ON fspace_account.username = fspace_fotografi.username
                                            WHERE `jenis_lomba` LIKE '%photography%' AND `validasi_payment`=0");
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" onclick="return confirm('Approve data?')" href="../../config/update/art_approve/fg.php?id=<?php echo $data['id']; ?>" role="button">✔</a><br>
