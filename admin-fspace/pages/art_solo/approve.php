...
<body>
    ...
    <div class="table-responsive jumbotron">
        <h2 class="text-success text-center">Data APPROVED Solo Vocal</h2>
        <a href="../" class="btn btn-info">⏎ Home</a>
        <a href="approve.php" class="btn btn-success">TO Approved</a>
        <a href="reject.php" class="btn btn-danger">TO Reject</a>
        <a href="../../config/art_excel_solo.php" class="btn btn-success float-right">Report Excel</a>
        <br><br>
        <table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            $tampil = mysqli_query($conn, "SELECT 
                                            ...
                                            WHERE `jenis_lomba` LIKE '%solo-vocal%' AND `validasi_payment`=1");
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" onclick="return confirm('Reject data?')" href="../../config/update/art_reject/sv.php?id=<?php echo $data['id']; ?>" role="button">╳</a>
                        </td>
                        <!-- <td>
