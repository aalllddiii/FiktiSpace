...
header("Content-Disposition: attachment; filename=Data APPROVE Anggota Lomba PUBGM.xls");
?>
...
<h3>Data APPROVE Anggota Lomba PUBGM</h3>
...
<table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
    ...
    $no = 1;
    $tampil = mysqli_query($conn, "SELECT * FROM fspace_pubgm WHERE `validasi`=1");
