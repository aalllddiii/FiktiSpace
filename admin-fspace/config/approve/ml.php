...
header("Content-Disposition: attachment; filename=Data APPROVED Lomba ML.xls");
?>
...
<table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
    ...
    $no = 1;
    $tampil = mysqli_query($conn, "SELECT * FROM `fspace_account` WHERE `jenis_lomba` LIKE '%mobile-legend%' AND `validasi_payment`=1");
