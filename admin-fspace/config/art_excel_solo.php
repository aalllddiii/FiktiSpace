...
header("Content-Disposition: attachment; filename=Data APPROVED Art Solo Vocal.xls");
?>
<?php
include "../koneksi.php";
?>
<h3>Data APPROVED Art Solo Vocal</h3>
...
<table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
    ...
    $tampil = mysqli_query($conn, "SELECT 
                                                ...
                                                FROM fspace_account INNER JOIN fspace_solovocal 
