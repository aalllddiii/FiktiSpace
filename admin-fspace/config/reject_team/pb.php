...
header("Content-Disposition: attachment; filename=Data Pendaftar Anggota Lomba Point Blank.xls");
?>
...
<h3>Data Pendaftar Team Lomba Point Blank</h3>
...
<table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
    ...
    $no = 1;
    $tampil = mysqli_query($conn, "SELECT * FROM fspace_pointblank WHERE `validasi`=0 AND `nama_lengkap` <> ''");
