...
header("Content-Disposition: attachment; filename=Data Pendaftar Anggota Lomba PUBGM.xls");
?>
...
<h3>Data Pendaftar Team Lomba PUBGM</h3>
...
<table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
    ...
    $no = 1;
    $tampil = mysqli_query($conn, "SELECT * FROM fspace_pubgm WHERE `validasi`=0 AND `nama_lengkap` <> ''");
